...
export const Experience: React.FC<ExperienceProps> = ({ darkMode }) => {
  ...
  const internshipExperiences = [
    ...
    },
    {
      ...
      image: "/logo/talan-logo.png",
      experienceImage: "/work/TALAN.jpg",
    ...
    },
    {
      ...
      image: "/logo/tunisie-telecom-logo.png",
