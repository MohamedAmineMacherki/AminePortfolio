  ...
  const enhancedAchievements: BaseItem[] = useMemo(() => [
    {
      ...
      year: "2021",
      photos: [
        { url: "src/assets/study/nasa.jpeg", caption: "NASA award ceremony" },
        ...
        { url: "src/assets/study/nasa2.jpeg", caption: "Team celebration" }
      ]
    },
    {
      ...
      year: "2022",
      photos: [
        { url: "src/assets/Pyora/1.jpeg", caption: "Project pitch presentation" },
        { url: "src/assets/Pyora/2.jpeg", caption: "Technical demonstration" },
        { url: "src/assets/Pyora/3.jpeg", caption: "Innovation award ceremony" },
        { url: "src/assets/Pyora/4.jpeg", caption: "Team presentation" },
        { url: "src/assets/Pyora/5.jpeg", caption: "Product demo" },
        { url: "src/assets/Pyora/6.jpeg", caption: "Award reception" },
        { url: "src/assets/Pyora/7.jpeg", caption: "Final presentation" },
        { url: "src/assets/Pyora/8.jpeg", caption: "Technical showcase" }
      ]
    }
  ], []);
  ...
  const associativeExperience: AssociativeItem[] = useMemo(() => [
    {
      ...
      photos: [
        { url: "src/assets/junior/1.jpg", caption: "Junior Enterprise launch event" },
        { url: "src/assets/junior/2.jpg", caption: "Entrepreneurship workshop" },
        { url: "src/assets/junior/3.jpg", caption: "Digital marketing training" },
        { url: "src/assets/junior/4.jpg", caption: "Marketing team meeting" },
        { url: "src/assets/junior/5.jpg", caption: "Team collaboration session" },
        { url: "src/assets/junior/6.jpg", caption: "Strategic planning meeting" },
        { url: "src/assets/junior/7.jpg", caption: "Project development" },
        { url: "src/assets/junior/8.jpg", caption: "Team building activity" },
        { url: "src/assets/junior/9.png", caption: "Organization meeting" },
        { url: "src/assets/junior/10.png", caption: "Team coordination" }
      ]
    },
    {
      ...
      photos: [
        { url: "src/assets/ieee/1.jpg", caption: "IEEE technology innovation conference" },
        { url: "src/assets/ieee/2.png", caption: "Technical training workshop" },
        { url: "src/assets/ieee/3.jpg", caption: "IEEE robotics competition" },
        { url: "src/assets/ieee/6.jpg", caption: "Awards ceremony" }
      ]
    },
    {
      ...
      photos: [
        ...
        { url: "src/assets/ieee/4.png", caption: "Ambassador event" }
      ]
    }
  ], []);
  ...
  const marathonExperience: MarathonItem[] = useMemo(() => [
    {
      ...
      distance: "10 km",
      photos: [
        { url: "src/assets/Djerba/1.jpeg", caption: "Marathon start with Team Sofrecom" },
        { url: "src/assets/Djerba/2.jpeg", caption: "Running with the team" },
        { url: "src/assets/Djerba/5.png", caption: "Finish line celebration" },
        { url: "src/assets/Djerba/3.jpeg", caption: "Team Sofrecom group photo" },
        { url: "src/assets/Djerba/6.png", caption: "Medal ceremony" }
      ]
    },
    {
      title: "Vaga Run",
      ...
      distance: "5 km",
      photos: [
        { url: "src/assets/VAGA/1.jpg", caption: "Pre-race preparation" },
        { url: "src/assets/VAGA/2.jpg", caption: "Race action" },
        { url: "src/assets/VAGA/3.jpeg", caption: "Complete Team Sofrecom" },
        { url: "src/assets/VAGA/5.jpg", caption: "Recovery moment" },
        { url: "src/assets/VAGA/4.jpg", caption: "Post-race celebration" },
        { url: "src/assets/VAGA/6.jpeg", caption: "Team achievement" }
      ]
    },
    {
      title: "Mahdia Run",
      ...
      distance: "16 km",
      photos: [
        { url: "src/assets/Mahdia/5.png", caption: "Early morning start" },
        { url: "src/assets/Mahdia/2.png", caption: "Coastal route running" },
        { url: "src/assets/Mahdia/1.jpg", caption: "Motivated Team Sofrecom" },
        { url: "src/assets/Mahdia/3.png", caption: "Beautiful coastal scenery" },
        { url: "src/assets/Mahdia/5.png", caption: "Finish line arrival" },
        { url: "src/assets/marathon/mahdia6.jpg", caption: "Team memory photo" }
      ]
    }
  ], []);
